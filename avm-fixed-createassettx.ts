...
// // * len_name: 00 12 
// // * name: 66 69 78 65 64 20 63 61 70 70 65 64 20 61 73 73 65 74 
...
// // * len_initial_states: 00 00 00 01 
// // * fx_type_id: 00 00 00 00 
...
//   const secpOutput: SecpOutput = new SecpOutput(amount, xAddresses, locktime, threshold)
...
//   const secpInput: SecpInput = new SecpInput(amt)
...
//   const name: string = "fixed capped asset" 
//   const symbol: string = "FCAP" 
//   const denomination: number = 5
//   const fcapSecpOutput = new SecpOutput(amount, xAddresses, locktime, threshold)

//   const initialStates: InitialStates = new InitialStates()
//   initialStates.addOutput(fcapSecpOutput)
